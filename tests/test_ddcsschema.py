...
import ddcsschema
from ddcsschema.claim import ClaimDict
from ddcsschema.schema import NIST256p, NIST384p, SECP256k1
from ddcsschema.legacy.migrate import migrate
from ddcsschema.signer import get_signer
from ddcsschema.uri import URI, URIParseError
from ddcsschema.decode import smart_decode
from ddcsschema.error import DecodeError, InvalidAddress
from ddcsschema.address import decode_address, encode_address
...
parsed_uri_matches = [
    ...
    ("ddcs://test", URI("test"), False),
    ("ddcs://test#%s" % claim_id_1, URI("test", claim_id=claim_id_1), False),
    ("ddcs://test:1", URI("test", claim_sequence=1), False),
    ("ddcs://test$1", URI("test", bid_position=1), False),
    ("@test", URI("@test"), True),
    ...
    ("ddcs://@test1:1/fakepath", URI("@test1", claim_sequence=1, path="fakepath"), True),
    ("ddcs://@test1$1/fakepath", URI("@test1", bid_position=1, path="fakepath"), True),
    ("ddcs://@test1#abcdef/fakepath", URI("@test1", claim_id="abcdef", path="fakepath"), True),
    ("@z", URI("@z"), True),
    ("@yx", URI("@yx"), True),
    ("@abc", URI("@abc"), True)
]
...
parsed_uri_raises = [
    ("ddcs://", URIParseError),
    ("ddcs://test:3$1", URIParseError),
    ("ddcs://test$1:1", URIParseError),
    ("ddcs://test#x", URIParseError),
    ("ddcs://test#x/page", URIParseError),
    ("ddcs://test$", URIParseError),
    ("ddcs://test#", URIParseError),
    ("ddcs://test:", URIParseError),
    ("ddcs://test$x", URIParseError),
    ("ddcs://test:x", URIParseError),
    ...
    ("ddcs://@test:", URIParseError),
    ("ddcs://test@", URIParseError),
    ("ddcs://tes@t", URIParseError),
    ("ddcs://test:1#%s" % claim_id_1, URIParseError),
    ("ddcs://test:0", URIParseError),
    ("ddcs://test$0", URIParseError),
    ("ddcs://test/path", URIParseError),
    ("ddcs://@test1#abcdef/fakepath:1", URIParseError),
    ("ddcs://@test1:1/fakepath:1", URIParseError),
    ("ddcs://@test1:1ab/fakepath", URIParseError),
    ("ddcs://test:1:1:1", URIParseError),
    ("whatever/lbry://test", URIParseError),
    ("ddcs://lbry://test", URIParseError),
    ("ddcs://❀", URIParseError),
    ("ddcs://@/what", URIParseError),
    ("ddcs://abc:0x123", URIParseError),
    ("ddcs://abc:0x123/page", URIParseError),
    ("ddcs://@test1#ABCDEF/fakepath", URIParseError),
    ("test:0001", URIParseError),
    ("ddcs://@test1$1/fakepath?arg1&arg2&arg3", URIParseError)
]
    ...
    def test_uri_parse(self):
        for test_string, expected_uri_obj, is_channel in parsed_uri_matches:
            try:
                ...
                if test_string.startswith('ddcs://'):
                    # string -> URI -> string
...
class TestRegtestAddressValidation(UnitTest):
    def setUp(self):
        ddcsschema.BLOCKCHAIN_NAME = "ddcscrd_regtest"

    def tearDown(self):
        ddcsschema.BLOCKCHAIN_NAME = "ddcscrd_main"
