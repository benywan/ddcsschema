...
from ddcsschema.schema import source_pb2 as source_pb, VERSION_MAP
from ddcsschema.schema import SOURCE_TYPES, DDCS_SD_HASH_LENGTH
from ddcsschema.schema.schema import Schema
from ddcsschema.error import InvalidSourceHashLength
...
class Source(Schema):
    ...
    def load(cls, message):
        ...
        assert len(sd_hash) == DDCS_SD_HASH_LENGTH, InvalidSourceHashLength(len(sd_hash))
